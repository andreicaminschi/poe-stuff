 ...
 *
 * Bucket bodies were quoted from `packages/filter/buckets-draft.json` on 2026-08-20. That
 * package is deleted; the quotes are kept because the contract they describe is what
 * `apps/generator` will have to satisfy, and it did not change when the POC went away.
 */
