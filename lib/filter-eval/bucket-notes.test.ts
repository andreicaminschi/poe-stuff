 ...
 * 74 distinct `family`/`verb`/`tier` combinations between them. That package is deleted, and
 * writing them out here rather than reading them off disk is why these tests still run —
 * this package stands alone on purpose, and always did.
 *
